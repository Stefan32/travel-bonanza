...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); /* Because you use jquery in the constructor function */
/* This is to make use of Waypoints */
...
var StickyHeader = function () {
  function StickyHeader() {
    ...
    this.lazyImages = (0, _jquery2.default)(".lazyload"); /* selects everything with lazyload in class */
  ...
  _createClass(StickyHeader, [{
    ...
    value: function createHeaderWaypoint() {
      ...
      new Waypoint({ /* We have acces to the waypoint class, because we imported it at the top */
        ...
        handler: function handler(direction) {
          /* Direction is there to enable different events on scrolling down or up  */
          if (direction == "down") {
            that.siteHeader.addClass("site-header--dark"); /* Targets the element and gives class */
          } else {
            /* Other direction would obviously be "up" */
    ...
    value: function createPageSectionWaypoints() {
      /* New method that will create waypoints for each element selected */
      var that = this;
